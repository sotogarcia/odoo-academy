...
of reference catalogs and training structures across the platform.
    ...
    "data": [
        ...
        "security/academy_change_training_action_wizard.xml",
        "security/academy_training_action_synchronize_wizard.xml",
        "security/academy_training_program_synchronize_wizard.xml",
        "security/academy_training_action_student_link.xml",
        "security/academy_maintenance_task.xml",
        ...
        "views/academy_student_signup_view.xml",
        ...
        "wizard/academy_change_training_action_wizard_view.xml",
    ...
    "demo": [
        ...
        "demo/academy_training_framework.xml",
