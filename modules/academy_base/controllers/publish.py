...
class Publish(http.Controller):
    ...
    def _serialize_activity(self, parent, activity_id):
        ...
        act_et = self.xml_item_id(parent, 'activity', activity,
                                  ID_TRAINING_ACTIVITY_FIELD_MAP)

        sectors = activity.professional_sector_ids
        self.xml_item_ids(act_et, "professional_sectors", sectors,
                          'professional_sector')
    ...
    def _serialize_action(self, parent, action_id):
        ...
        act_et = self.xml_item_id(parent, 'action', action,
                                  ID_TRAINING_ACTIVITY_FIELD_MAP)
    ...
    @http.route('/academy_catalog/activity/<activity_id>', type='http', auth="public")
    ...
    @http.route('/academy_catalog/action/<action_id>', type='http', auth="public")
    def action(self, **kw):
