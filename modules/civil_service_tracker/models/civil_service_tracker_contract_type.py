...
class CivilServiceTrackerContractType(models.Model):

    _name = 'civil.service.tracker.contract.type'
    _description = u'Civil service tracker contract type'

    _table = 'cst_contract_type'
