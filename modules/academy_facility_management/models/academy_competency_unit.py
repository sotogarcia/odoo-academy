...
class AcademyCompetencyUnit(models.Model):
    """ Allow to assign several facilities to the competency unit
    """
    ...
    facility_assignment_ids = fields.One2many(
        ...
        index=False,
        default=None,
        help='Facilities used for teaching this competence unit',
    ...
    facility_count = fields.Integer(
        ...
        index=False,
        default=0,
        help='Number of facilities used for teaching this competence unit',
    ...
    def view_facility_assignments(self):
        ...
        action_xid = ('academy_facility_management.action_academy_training_'
