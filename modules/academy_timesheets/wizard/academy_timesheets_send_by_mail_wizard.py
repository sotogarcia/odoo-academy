...
class AcademyTimesheetsSendByMailWizard(models.TransientModel):
    ...
    _description = "Academy timesheets send by mail"
    ...
    force_send = fields.Boolean(
        ...
        default=False,
        help=(
            "If True, the generated mail will be immediately sent after "
    ...
    def _correct_dates(self, stop_changes=False):
        msg = self.env._("Last date should be later than first date")
    ...
    def _validate(self):
        ...
        if self.date_stop < self.date_start:
            msg = self.env._("The interval cannot end without having started")
            raise ValidationError(msg)
