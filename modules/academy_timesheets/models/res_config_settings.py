...
class ResConfigSettings(models.TransientModel):
    ...
    teacher_report_download = fields.Boolean(
        ...
        index=False,
        default=None,
        help=_('If set to TRUE the report will be downloaded instead of '
    ...
    schedule_for_next_week_from_time = fields.Float(
        ...
        default=14.0,
        digits=(16, 2),
        help=('Time from which the schedule of the following week will be '
              'shown'),
    ...
    wait_to_fill = fields.Float(
        ...
        help=('Time during which the information of the last created session '
              'will be kept')
    )
