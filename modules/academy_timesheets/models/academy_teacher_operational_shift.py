...
class AcademyTeacherOperationalShift(models.Model):
    ...
    _description = u'Teacher Operational Shift Management'
    ...
    company_id = fields.Many2one(
        ...
        index=True,
        default=None,
        help=('Identifier of the company to which this operational shift '
    ...
    teacher_id = fields.Many2one(
        ...
        index=True,
        default=None,
        help=('Reference to the academy teacher associated with this '
    ...
    date_start = fields.Datetime(
        ...
        help=('The start date and time of the operational shift. Indicates '
    ...
    date_stop = fields.Datetime(
        ...
        index=True,
        default=fields.datetime.now(),
        help=('The end date and time of the operational shift. Specifies when '
    ...
    date_delay = fields.Float(
        ...
        default=0.0,
        digits=(16, 2),
        help=('Specifies the duration of the operational shift in hours. '
    ...
    session_count = fields.Integer(
        ...
        index=False,
        default=0,
        help=('Total number of sessions or activities conducted during this '
