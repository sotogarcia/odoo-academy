...
class AcademyTrainingSessionAffinity(models.Model):
    ...
    _description = "Academy training session available student"
    ...
    image_1024 = fields.Image(
        string="Image 1024", related="student_id.image_1024"
    )

    image_512 = fields.Image(
        string="Image 512", related="student_id.image_512"
    )

    image_256 = fields.Image(
        string="Image 256", related="student_id.image_256"
    )
    ...
    _view_sql = """
        SELECT
            ...
            NULL::TIMESTAMP(0) AS create_date,
            NULL::INTEGER AS write_uid,
            NULL::TIMESTAMP(0) AS write_date,
            NULL::INTEGER AS session_id,
            NULL::INTEGER AS training_action_id,
            NULL::INTEGER AS program_line_id,
            NULL::INTEGER AS enrolment_id,
            NULL::INTEGER AS student_id,
            NULL::BOOLEAN AS invited,
