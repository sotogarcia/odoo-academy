...
class CivilServiceRecruitmentHiringType(models.Model):
    """ Type of hiring.
    ...
    _name = 'civil.service.recruitment.hiring.type'
    _description = u'Civil service recruitment, hiring type of public employee'
