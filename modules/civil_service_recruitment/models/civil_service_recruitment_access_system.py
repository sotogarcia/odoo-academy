...
class CivilServiceRecruitmentAccessSystem(models.Model):
    """ Indicates which citizens can take the exam

    This can be: Open, Internal promotion, Consolidation
    """

    _name = 'civil.service.recruitment.access.system'
    _description = u'Civil service recruitment, access system of public employee'
