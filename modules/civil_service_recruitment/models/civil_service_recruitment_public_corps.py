...
class CivilServiceRecruitmentPublicCorps(models.Model):
    """ Professional profiles in which public administration positions are
    classified.
    """

    _name = 'civil.service.recruitment.public.corps'
    _description = u'Civil service recruitment corps'
    ...
    description = fields.Text(
        ...
        index=False,
        default=None,
        help="Something about this vacancy type",
        translate=True
    )
    ...
    specialization_id = fields.Many2one(
        ...
        comodel_name='civil.service.recruitment.required.specialization',
        domain=[],
        context={},
        ondelete='cascade',
        auto_join=False
