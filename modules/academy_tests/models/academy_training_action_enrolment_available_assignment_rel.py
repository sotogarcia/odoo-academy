...
class AcademyTrainingActionEnrolmentAvailableAssignmentRel(models.Model):
    ...
    academy.training.action and academy.tests.test.training.assignment
    """

    _name = 'academy.training.action.enrolment.available.assignment.rel'
    _description = u'Academy training action enrolment available assignment'

    _order = 'training_action_id DESC, assignment_id DESC'
