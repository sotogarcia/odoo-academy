    ...
    def _build_view_sql():
        ...
        return '''
            SELECT
                ...
                NULL AS answered_count,
                NULL AS right_count,
                NULL AS wrong_count,
                NULL AS blank_count,
                NULL AS answer_count,
                NULL AS doubt_count,
                NULL AS right_points,
                NULL AS wrong_points,
                NULL AS blank_points,
                NULL AS final_points,
                NULL AS max_points,
                NULL AS right_percent,
                NULL AS wrong_percent,
                NULL AS blank_percent,
                NULL AS answered_percent,
                NULL AS passed,
                NULL AS grade,
                NULL AS right_score,
                NULL AS wrong_score,
                NULL AS blank_score,
                NULL AS final_score,
                NULL AS test_owner_id,
                NULL AS final_answer_helper_ids,
                NULL AS rating,
                NULL AS rank
        '''
